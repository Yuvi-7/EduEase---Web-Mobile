...
import { FeesAreaChart } from '@/components/charts/FeesAreaChart'
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        <StatCard
          eye="Today's attendance" value="94.2" suffix="%" delta="1.4%" deltaDir="up"
          foot="1,184 of 1,256 present"
        />
        <StatCard
          eye="Active students" value="1,256" delta="12 this term" deltaDir="up"
          foot="across 42 classes"
        />
        <StatCard
          eye="Fees collected · May" value="₹14.2" suffix="L"
          foot="On track for ₹16L target"
          spark={[30, 55, 42, 65, 50, 78, 90]}
        />
        <StatCard
          eye="Open requests" value="7" delta="2 since yesterday" deltaDir="up"
          foot="3 leave · 4 admission"
        />
      </div>
