    ...
    <div className="grid min-h-screen" style={{ gridTemplateColumns: '1fr 1fr' }}>
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      isActive ? 'shadow-[0_0_0_2px]' : 'hover:shadow-[var(--shadow-1)] bg-white'
                    )}
                    style={{
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate>
            ...
            <div className="flex flex-col gap-1.5 mb-4">
              ...
              <input
                ...
                autoComplete="email"
                onChange={e => { register('email').onChange(e); setActiveDemo(null); setServerError('') }}
                className={cn(
            ...
            <div className="flex flex-col gap-1.5 mb-4">
              <div className="flex items-center justify-between">
                ...
                <button type="button" className="text-[11px] font-semibold text-[var(--scholar-600)] cursor-pointer">Forgot?</button>
              </div>
              <div className="relative">
                <input
                  ...
                  onChange={e => { register('password').onChange(e); setActiveDemo(null); setServerError('') }}
                  className={cn(
            ...
            <div className="text-center mt-4 text-[13px] text-[var(--ink-3)]">
              Need help?{' '}
              <button type="button" className="text-[var(--scholar-600)] font-semibold cursor-pointer">Contact support</button>
            </div>
          </form>
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <blockquote className="text-[34px] leading-[1.2] max-w-[480px]" style={{ fontWeight: 500, letterSpacing: '-0.02em' }}>
          ...
          <div className="flex items-center gap-3.5 mt-7">
            <div className="w-11 h-11 rounded-full flex items-center justify-center font-semibold flex-shrink-0" style={{ background: 'var(--coral-500)' }}>
              RM
            </div>
            <div>
        ...
        <div className="relative z-10">
          <div className="text-[11px] uppercase tracking-[0.06em] font-semibold opacity-60 mb-4">What each role can access</div>
